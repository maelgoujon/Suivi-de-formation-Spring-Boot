...
@Embeddable
@Getter
public enum MateriauxSerrurerieListe {
    ...
    SERRURE_STANDARD_ENCASTRABLE_CYLINDRE("Serrure standard encastrable NF Cylindre européen"),
    ...
    MateriauxSerrurerieListe(String optionName) {
